...
- [ ] Explain what a token is used for.
  A token is granted by the server to give access to restricted routes if the user has permission.
- [ ] What steps can you take in your web apps to keep your data secure?
  Use client side and server side authentication, use private routes.
- [ ] Describe how web servers work.
  It's a program that uses HTTP to serve files that form web pages in response to requests made from devices.
